...
def get_context(context):
	...
	context.apk_url = "/assets/sbi_projects/site_app/sbi-site.apk"      # Android APK (direct install)
	context.exe_url = "/assets/sbi_projects/site_app/sbi-site.msix"     # Windows MSIX
