...
Set-Content -Path "sbi_projects\sbi_projects\doctype\steel_fabrication_import\steel_fabrication_import.py" -Value $code -Encoding UTF8

Select-String -Path "sbi_projects\sbi_projects\doctype\steel_fabrication_import\steel_fabrication_import.py" -Pattern "def _get_file_bytes" | Select-Object LineNumber, Line
git diff --stat
