...
RESOURCES = [
	...
	("Labour", "Mason", "Day", 1200, 0),
	("Labour", "M/C (Male Coolie)", "Day", 1200, 0),
	("Labour", "F/C (Female Coolie)", "Day", 900, 0),
	("Machinery", "JCB", "Hour", 1000, 0),
	("Machinery", "Crane", "Hour", 300, 0),
	("Machinery", "Vibrator", "Hour", 65, 0),
	("Machinery", "Surveyor", "Day", 5000, 0),
	("Subcontractor", "Erection", "Kg", 10, 0),
	("Subcontractor", "Sheet Laying", "Sqm", 11, 0),
]
